...
class __TwigTemplate_bcd6a4180bb10ddefcab18f6dc47c73f extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"container\">
      <div class=\"row\">
        ...
        echo "\"
                ...
                ";
        // line 42
        echo "                <button class=\"btn btn-lg btn-primary mt-3\"type=\"submit\" name=\"login\"/>
                    Sign in
                </button>
            </form>
        </div>
...
";
    ...
    {
        return array (  139 => 42,  133 => 29,  125 => 24,  120 => 21,  112 => 18,  109 => 17,  107 => 16,  104 => 15,  98 => 13,  96 => 12,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
        ...
        <div class=\"col-lg-6 align-self-center\">
          <div class=\"header-text\">
            <form method=\"post\">
                ...
                #}
                <button class=\"btn btn-lg btn-primary mt-3\"type=\"submit\" name=\"login\"/>
                    Sign in
                </button>
            </form>
        </div>
...
{% endblock %}
", "security/login.html.twig", "/home/htdocs/sp1/templates/security/login.html.twig");
    }
}
